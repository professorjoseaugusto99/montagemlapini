document.addEventListener("DOMContentLoaded", () => {
    ...
    const firebaseConfig = {
      // Exemplo:
      // apiKey: "Sua_Api_Key",
      // authDomain: "simuladordefeitos...",
      // ... cole todas as chaves aqui!
    };
    // ------------------------------------------------
    ...
    // --- BANCO DE DADOS (V9.0 - Mantido da V8.0) ---
    const allActionsDB = {
        hardware: [
    ...
    const problemsDB = [
        { symptom: "Meu PC liga, todas as ventoinhas giram, mas não dá vídeo e minha placa-mãe não emite bipes.", solution_id: "action_ram", close_guess_ids: ["action_gpu", "action_mobo", "action_psu"], points_reward: 250, feedbackCorrect: "Perfeito! Era um módulo de RAM com mau contato. Você reencaixou e o PC deu vídeo." },
    ...
    const adminScreen = document.getElementById("admin-screen"); // Novo
    
    const submitNameButton = document.getElementById("submit-name-button");
    const startButton = document.getElementById("start-button");
    const playAgainButton = document.getElementById("play-again-button");
    const nextButton = document.getElementById("next-button");
    const openAdminButton = document.getElementById("open-admin-button"); // Novo
    const closeAdminButton = document.getElementById("close-admin-button"); // Novo
    ...
    const adminLeaderboardDisplay = document.getElementById("admin-leaderboard-display"); // Novo
    ...
    let leaderboard = []; // Agora vai guardar também os IDs (chaves) do Firebase
    ...
    // NOVO: Função que o Admin usa para excluir do banco de dados
    ...
    function displayLeaderboard(elementId, isAdmin = false) {
        ...
        leaderboard.forEach((entry, index) => {
            ...
            // Se for o painel de admin, adicionamos o botão de excluir
            if (isAdmin) {
                li.innerHTML = `
    ...
    function setupLeaderboardListener() {
        ...
        leaderboardRef.on('value', (snapshot) => {
            ...
            if (data) {
                // Novo formato: mapeia para incluir o ID do Firebase
                ...
                // Top 10 para os alunos. No admin, podemos mostrar mais se quisermos, 
                // mas vamos manter top 15 aqui por via das dúvidas.
            ...
            displayLeaderboard('admin-leaderboard-display', true); // Atualiza o painel admin tbm
        });
    }
